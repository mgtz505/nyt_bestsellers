...
const About = (type) => {
    ...
    return (
        <div>
            ...
            <nav ref={dropDownRef} className={`abmenu ${isActive ? 'active' : 'inactive'}`}>
                <h2>Welcome to NYT Books!</h2>
                <p> Looking for a new read? 
                    Select a category using the drop-down menu, click on a title, then scroll down for more details!
